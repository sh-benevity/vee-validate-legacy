...
export function localize(dictionary: RootI18nDictionary): void
export function localize(locale: string, dictionary?: PartialI18nDictionary): void
export function localize(locale: string | RootI18nDictionary, dictionary?: PartialI18nDictionary) {
  if (!DICTIONARY) {
